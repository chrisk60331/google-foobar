...
@pytest.mark.parametrize(
    "res, exp", [
        [[[Fraction(1, 6), Fraction(1, 5), Fraction(1, 5)], [Fraction(1, 5), Fraction(1, 5), Fraction(1, 5)]], 30],
        [[[Fraction(1, 3), Fraction(2, 7), Fraction(8, 21)], [Fraction(0, 1), Fraction(3, 7), Fraction(4, 7)]], 21],
        [[
